    ...
    [Authority.SYS_ADMIN, {
      links: [
        ...
        },
        {
          ...
          link: 'https://smart-life.sa/docs/user-guide/ui/widget-library/'
        }
      ]
    }],
    [Authority.TENANT_ADMIN, {
      links: [
        ...
        },
        {
          icon: 'insert_chart',
          name: 'API',
          link: 'https://smart-life.sa/docs/api/'
        },
        {
          icon: 'devices',
          name: 'Device profiles',
          link: 'https://smart-life.sa/docs/user-guide/device-profiles/'
        }
      ]
    }],
